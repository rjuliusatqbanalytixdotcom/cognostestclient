...
public class InvokeListenerIsReadyThread extends AbstractServerInvokerThread {

	public InvokeListenerIsReadyThread(IServerInvokerListener serverInvokerListener) {
